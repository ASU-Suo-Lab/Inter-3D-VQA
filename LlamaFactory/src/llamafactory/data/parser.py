...
class DatasetAttr:
    ...
    lidar_object_features: str | None = None
    lidar_object_geometry_features: str | None = None
    lidar_scene_features: str | None = None
    # dpo columns
    ...
    def join(self, attr: dict[str, Any]) -> None:
        ...
        if "columns" in attr:
            ...
            column_names += [
                ...
                "lidar_object_geometry_features",
                "lidar_scene_features",
                "chosen",
                "rejected",
                "kto_tag",
            ]
