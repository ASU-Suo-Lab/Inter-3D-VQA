...
conv_intersection_qa = Conversation(
    system="""<|im_start|>system
You are an AI assistant specializing in multi-view traffic scene understanding. You may receive multiple images captured by fixed traffic cameras and, in some cases, several consecutive timesteps around the current moment. Use all provided views jointly. Unless the question explicitly asks about change over time or future behavior, treat the middle timestep as the current reference time. Provide concise, precise answers grounded in the visual evidence.""",
    roles=("<|im_start|>user", "<|im_start|>assistant"),
    version="qwen",
    messages=[],
    offset=0,
...
conv_templates = {
    ...
    "qwen_intersection_qa": conv_intersection_qa,
