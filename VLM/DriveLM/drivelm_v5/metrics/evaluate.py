...
from drivelm_v5.config.common import DEFAULT_DATASET_VERSION, DEFAULT_EVAL_DIR, DEFAULT_PREPARED_DIR, DEFAULT_RESULTS_DIR, resolve_dataset_version_paths
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate DriveLM Intersection V5 predictions.")
    ...
    parser.add_argument("--output-dir", default=str(DEFAULT_EVAL_DIR))
...
def main() -> None:
    ...
    if args.predictions:
        ...
        pred_dir = Path(args.pred_dir or DEFAULT_RESULTS_DIR).resolve()
