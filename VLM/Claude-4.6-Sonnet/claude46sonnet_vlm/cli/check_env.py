...
from claude46sonnet_vlm.config.common import DEFAULT_DATASET_VERSION, FORWARD_DEFAULTS, resolve_dataset_version_paths
from claude46sonnet_vlm.utils.io import ensure, load_json
from claude46sonnet_vlm.utils.secrets import resolve_api_key


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate Claude 4.6 Sonnet intersection inference prerequisites.")
