...
from claude46sonnet_vlm.config.common import (
...
from claude46sonnet_vlm.utils.client import Claude46SonnetClient
from claude46sonnet_vlm.utils.io import append_jsonl, dump_json, dump_jsonl, ensure, load_json, load_jsonl
from claude46sonnet_vlm.utils.prompting import build_system_prompt, build_user_prompt, load_prompt_bundle


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Claude intersection forward.")
    ...
    parser.add_argument("--temperature", type=float, default=FORWARD_DEFAULTS["temperature"])
    parser.add_argument("--max-output-tokens", type=int, default=FORWARD_DEFAULTS["max_output_tokens"])
    parser.add_argument("--max-image-edge", type=int, default=FORWARD_DEFAULTS["max_image_edge"])
