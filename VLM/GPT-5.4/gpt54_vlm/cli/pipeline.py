...
from gpt54_vlm.config.common import DEFAULT_DATASET_VERSION, PACKAGE_NAME, REPO_ROOT, ensure_worktree_layout, resolve_dataset_version_paths
from gpt54_vlm.utils.io import load_json


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the GPT-5.1 intersection pipeline.")
