...
from gemini31pro_vlm.config.common import DEFAULT_DATASET_VERSION, FORWARD_DEFAULTS, resolve_dataset_version_paths
from gemini31pro_vlm.utils.io import ensure, load_json
from gemini31pro_vlm.utils.secrets import resolve_api_key


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate Gemini intersection inference prerequisites.")
