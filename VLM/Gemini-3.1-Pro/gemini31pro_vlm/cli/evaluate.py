...
from gemini31pro_vlm.config.common import DEFAULT_DATASET_VERSION, ensure_worktree_layout, resolve_dataset_version_paths
from gemini31pro_vlm.utils.io import dump_json, dump_jsonl, ensure, load_json, load_jsonl


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Gemini intersection predictions.")
